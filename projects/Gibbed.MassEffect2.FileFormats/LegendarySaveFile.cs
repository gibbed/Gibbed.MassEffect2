...
{
    public class LegendarySaveFile : SaveFileBase
    {
        [UnrealFieldCategory("5. Other")]
        [UnrealFieldDisplayName("ME1 Import Rewards")]
        public Save.Me1ImportRewards Me1ImportRewards;
        ...
        protected override void Serialize(IUnrealStream stream)
        {
            ...
            stream.Serialize(ref this.Me1ImportRewards);
